...
- FINDING **Judge model: 1.5b is too weak.** qwen2.5:1.5b-instruct produced inverted/garbage grades (correct StreamingResponse graded 1-2, wrong section 5+; batch returned None). Moving to qwen2.5:3b-instruct. The judge idea is sound; the model size matters. Fail-safe still protects (bad/absent judge -> cosine).
